...
{
    public class QueenFigure : IFigure
    {
        private Team team;
        public Team Team => team;

        public FigureType Type => FigureType.Queen;
        ...
        public LinkedList<Position> NonSafetyMovePaths
        {
            get
            {
                ...
                for (tempPosition = Position + new Point(0, 1); ; tempPosition += new Point(0, 1))
                {
                    if (!board.IsValidPosition(tempPosition)) break;
                    if (!board.IsFreePosition(tempPosition))
                    {
                ...
                for (tempPosition = Position + new Point(1, 0); ; tempPosition += new Point(1, 0))
                {
                    if (!board.IsValidPosition(tempPosition)) break;
                    if (!board.IsFreePosition(tempPosition))
                    {
        ...
        public QueenFigure(Position position, Team team, IBoard board)
        {
            this.team = team;
            this.position = position;
            this.board = board;
